...
(this.version = '3.7.4'), (this.name = 'nicescroll'), (this.me = p)
      ...
      if ((n.extend(M, g), (M.snapbackspeed = 80), e)) for (const L in M) void 0 !== e[L] && (M[L] = e[L])
      if (
        ...
        P == 'horizontal-tb' || P == 'lr-tb' || P === ''
          ? ((this.isrtlmode = C.css('direction') == 'rtl'),
            (this.isvertical = !1))
          : ((this.isrtlmode =
              P == 'vertical-rl' || P == 'tb' || P == 'tb-rl' || P == 'rl-tb'),
            (this.isvertical = P == 'vertical-rl' || P == 'tb' || P == 'tb-rl'))
      } else {
...
(T.rail.drag.x += d.left), (T.rail.drag.y += d.top)
              ...
              const z = M.emulatetouch && T.isiframe && !N.hasmousecapture;
            ...
            if (
              ...
              (T.onmousemove = function(e) {
                if (T.rail.drag) {
                  ...
                  if (N.ischrome && e.which === 0) return T.onmouseup(e)
                  if (
                    ((T.cursorfreezed = !0),
                    T.hasmoving ||
                      T.triggerScrollStart(e.clientX, e.clientY, 0, 0, 0),
...
(T.hasTextSelected =
            ...
            if (
              ...
              const C = T.win.attr('style');
                const P = parseFloat(T.win.css('width')) + 1
              T.win.css('width', P),
                  ...
                  (!1 !== m
                    ? ((T.observer = new m(function(e) {
                      ...
                      (T.observerremover = new m(function(e) {
                        e.forEach(function(e) {
                          if (e.removedNodes.length > 0) for (const o in e.removedNodes) if (T && e.removedNodes[o] == T.win[0]) return T.remove()
                        })
                      })),
...
(this.onscreenresize = function(e) {
        ...
        (this.mousewheel = function(e, o, t) {
          ...
          if ('onwheel' in l.createElement('div')) {
            ...
            const i =
              void 0 !== l.onmousewheel ? 'mousewheel' : 'DOMMouseScroll'
            S(r, i, o, t || !1),
      ...
      ;(this.delegate = function(e, o, t, r, i) {
        ...
        (this.undelegate = function(e, o, t, r, i) {
          const s = d[o] || !1
          if (s) for (let n = 0, l = s.l.length; n < l; n++) {
              s.a[n] === T.id &&
                (s.a.splice(n),
                s.l.splice(n),
                s.a.length === 0 && (T._unbind(e, o, del.f), (d[o] = null)))
            }
        }),
      ...
      if (
        ...
        if (
          ...
          {(this.doScrollLeft = function(e, o) {
            let t = T.scrollrunning ? T.newscrolly : T.getScrollTop()
            T.doScrollPos(e, t, o)
          }),
            (this.doScrollTop = function(e, o) {
              let t = T.scrollrunning ? T.newscrollx : T.getScrollLeft()
              T.doScrollPos(t, e, o)
            }),
            (this.doScrollPos = function(e, o, t) {
              let r = T.getScrollTop(),
                i = T.getScrollLeft();
((T.newscrolly - r) * (o - r) < 0 ||
                (T.newscrollx - i) * (e - i) < 0) &&
                T.cancelScroll()
...
(T.newscrolly = o),
                ...
                (T.dst.px = i),
                (T.dst.py = r)
              let n = 0 | Math.sqrt(T.dst.x * T.dst.x + T.dst.y * T.dst.y),
