...
(m.fn = m.prototype = {
    ...
    (m.extend = m.fn.extend = function() {
      ...
      for (
        ...
        i > h;
        h++
      ) if ((e = arguments[h]) != null) for (d in e) {
            ;(a = g[d]),
              (c = e[d]),
              g !== c &&
  ...
  (m.event = {
    ...
    handlers: function(a, b) {
      let c,
        ...
        h = b.delegateCount,
        i = a.target
      if (h && i.nodeType && (!a.button || a.type !== 'click')) for (; i != this; i = i.parentNode || this) {
...
(rb.optgroup = rb.option),
  ...
  m.extend({
    clone: function(a, b, c) {
      ...
      if (b) if (c) for (h = h || ub(a), d = d || ub(f), g = 0; (e = h[g]) != null; g++) Ab(e, d[g])
        else Ab(a, f)
      return (
        (d = ub(f, 'script')),
